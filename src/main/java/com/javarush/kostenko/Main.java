...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // close the current session to ensure the request is made to the database, not fetching data from the cache
        main.sessionFactory.getCurrentSession().close();

        // select 10 random city IDs
        // since we haven't handled invalid cases, use the existing IDs from the database
